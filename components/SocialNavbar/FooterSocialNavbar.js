    ...
    <div className="flex items-center self-center flex-1 flex-wrap-reverse sm:flex-wrap">
      ...
      <ul className="m-0 max-w-full flex flex-1 flex-wrap sm:flex-nowrap self-center">
        <li className="h-12 w-12 inline-flex items-center self-center leading-normal">
          <Link href={"/"}>
            <a className="mr-0.5 h-full w-full mx-auto p-0.5 bg-bright_blue hover:bg-[#e8eaed] outline-0 focus:outline focus:outline-2 focus:outline-dark_blue flex items-center justify-center">
        ...
        <li className="mr-0.5 h-12 w-12 inline-flex items-center self-center leading-normal">
          <Link href={"/"}>
            <a className="h-full w-full mx-auto p-0.5 bg-bright_blue hover:bg-[#e8eaed] outline-0 focus:outline focus:outline-2 focus:outline-dark_blue flex items-center justify-center">
      ...
      <div className="mb-6 sm:mb-0 pb-5 sm:pb-0 w-full sm:w-auto flex items-center justify-end border-b border-solid border-gray sm:border-none">
        <GrLanguage />
        <Link href="/">
          <a className="ml-2 px-2.5 py-1.5 min-w-[48px] text-center text-[#202124] hover:bg-[#1a73e80a] outline-none focus:outline focus:outline-2 focus:outline-dark_blue rounded">
            English
          </a>
        </Link>
      </div>
